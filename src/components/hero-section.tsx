      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 text-center">
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 transition-transform duration-300 group-hover:scale-110 whitespace-nowrap font-[var(--font-montserrat)] tracking-[0.15em] uppercase text-sm md:text-base">Discover</span>
            {/* Ripple Effect */}
          ...
          >
            <svg className="h-5 w-5 sm:h-5 sm:w-5 md:h-6 md:w-6 transition-all duration-300 group-hover:translate-x-2 group-hover:scale-110 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
            </svg>
            <span className="transition-transform duration-300 group-hover:scale-105 whitespace-nowrap font-[var(--font-montserrat)] tracking-[0.15em] uppercase text-sm md:text-base">Learn More</span>
          </Button>
        </motion.div>
      </div>
