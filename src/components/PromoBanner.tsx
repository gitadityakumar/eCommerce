...
export default function PromoBanner() {
  return (
    <section className="relative flex min-h-[72dvh] items-center justify-center overflow-hidden bg-background transition-colors duration-500">
      <motion.div
        initial={{ scale: 1.1 }}
        animate={{ scale: 1 }}
      ...
      >
        <div className="absolute inset-0 bg-background/45 dark:bg-background/68 z-10 transition-colors duration-500"></div>
        <Image
      ...
      >
        <span className="block text-accent text-xs tracking-[0.32em] uppercase mb-6 drop-shadow-sm">Limited atelier run</span>
        <h2 className="text-5xl md:text-7xl text-text-primary font-light tracking-[-0.055em] mb-8">The gala edit</h2>
        <p className="text-text-secondary font-light text-lg mb-10 max-w-lg mx-auto leading-relaxed">
          Crystal-touched bows, vintage lace, and satin pieces made for long evenings and close-up photography.
        </p>
